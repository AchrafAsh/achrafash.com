...
export const title = 'Taking a Hard Decision'
export const tag = 'daily'
export const publishedAt = '2022-4-19'
export const toc = []
...
Not gonna lie, I still have some doubts and fears, but this time I'm onboard with
it. No decision will ever feel easy and given.
